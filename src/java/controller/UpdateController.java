...
public class UpdateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pdescription = new String( request.getParameter("description").getBytes("ISO-8859-1"), "UTF-8");
        String pcategory = new String( request.getParameter("category").getBytes("ISO-8859-1"), "UTF-8");
        DAO dao = new DAO();
